...
public class LineAdapter extends RecyclerView.Adapter {
  ...
  private LineViewHolder lineViewHolder;

  public LineAdapter(@NonNull MaterialLeanBackSettings settings,
      @NonNull MaterialLeanBack.Adapter adapter, MaterialLeanBack.Customizer customizer) {
  ...
  @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int type) {
    ...
    switch (type) {
      ...
      case CELL:
        view =
            LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mlb_row, viewGroup, false);
        lineViewHolder = new LineViewHolder(view, adapter, settings, customizer);
  ...
  @Override public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int row) {
  ...
  public LineViewHolder getLineViewHolder() {
    return lineViewHolder;
  }
