...
public class MaterialLeanBackSettings {
  ...
  protected void handleAttributes(Context context, AttributeSet attrs) {
    try {
      ...
      if (styledAttrs.hasValue(R.styleable.MaterialLeanBack_mlb_titleBackGroundColor)) {
        titleBackGroundColor =
            styledAttrs.getColor(R.styleable.MaterialLeanBack_mlb_titleBackGroundColor, -1);
      }
      titleGravity =
          styledAttrs.getColor(R.styleable.MaterialLeanBack_mlb_titleGravity, Gravity.CENTER);
      ...
      elevationEnlarged =
          styledAttrs.getInteger(R.styleable.MaterialLeanBack_mlb_cardElevationEnlarged, 8);
      elevationReduced =
          styledAttrs.getInteger(R.styleable.MaterialLeanBack_mlb_cardElevationReduced, 5);

      {
        if (styledAttrs.hasValue(R.styleable.MaterialLeanBack_mlb_paddingTop)) {
          paddingTop =
              styledAttrs.getDimensionPixelOffset(R.styleable.MaterialLeanBack_mlb_paddingTop, -1);
        }
        if (styledAttrs.hasValue(R.styleable.MaterialLeanBack_mlb_paddingBottom)) {
          paddingBottom =
              styledAttrs.getDimensionPixelOffset(R.styleable.MaterialLeanBack_mlb_paddingBottom,
                  -1);
        }
        if (styledAttrs.hasValue(R.styleable.MaterialLeanBack_mlb_paddingLeft)) {
          paddingLeft =
              styledAttrs.getDimensionPixelOffset(R.styleable.MaterialLeanBack_mlb_paddingLeft, -1);
        }
        if (styledAttrs.hasValue(R.styleable.MaterialLeanBack_mlb_paddingRight)) {
          paddingRight =
              styledAttrs.getDimensionPixelOffset(R.styleable.MaterialLeanBack_mlb_paddingRight,
                  -1);
        }
      }

      {
        ...
        if (styledAttrs.hasValue(R.styleable.MaterialLeanBack_mlb_backgroundOverlay)) {
          backgroundOverlay =
              styledAttrs.getFloat(R.styleable.MaterialLeanBack_mlb_backgroundOverlay, -1);
        }

        if (styledAttrs.hasValue(R.styleable.MaterialLeanBack_mlb_backgroundOverlayColor)) {
          backgroundOverlayColor =
              styledAttrs.getColor(R.styleable.MaterialLeanBack_mlb_backgroundOverlayColor, -1);
        }
      }

      if (styledAttrs.hasValue(R.styleable.MaterialLeanBack_mlb_lineSpacing)) {
        lineSpacing =
            styledAttrs.getDimensionPixelOffset(R.styleable.MaterialLeanBack_mlb_lineSpacing, -1);
      }
